...
export function Hero() {
  return (
    <section id="top" className="bg-gradient-to-b from-terracotta-50 to-white">
      <div className="mx-auto max-w-5xl px-4 py-8 text-center sm:py-12">
        <p className="text-sm font-medium uppercase tracking-wide text-terracotta-600">Cuisine africaine fait maison</p>
        <h1 className="mt-1.5 text-3xl font-bold text-stone-900 sm:text-5xl">{RESTAURANT_NAME}</h1>
        ...
        <p className="mx-auto mt-1.5 max-w-xl text-base font-semibold text-terracotta-700">
          Les Saveurs de Safia : l&apos;Afrique dans votre assiette !
        </p>
        <a
          href="#menu"
          className="mt-4 inline-block rounded-full bg-terracotta-600 px-5 py-2.5 text-base font-medium text-white shadow-sm transition hover:bg-terracotta-700"
        >
          Voir nos saveurs
        </a>
      </div>
